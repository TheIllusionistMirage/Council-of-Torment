...
enum ItemID
{
	EMPTY_BOTTLE, HEALTH_POTION, MANA_POTION, HEALTH_FLASK, MANA_FLASK, RUSTY_BLADE, DUSTY_TOME, SCROLL_OF_FIREBALL,
	RAW_SALMON, HANDFUL_MUSHROOMS, IRON_INGOT, STEEL_INGOT, SILVER_INGOT, GOLD_INGOT, HARDIUM_INGOT, IRON_ORE,
	COAL, SILVER_ORE, GOLD_ORE, HARDIUM_ORE, WATER_BOTTLE, EMPTY_FLASK, FLASK_OF_WATER,
